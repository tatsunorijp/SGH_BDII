...
public class ControleTelaPrincipalAdmin implements Initializable{
    @FXML
    ...
    public void showUsuarios(ActionEvent event) throws IOException{
        window.setFragment("/sistemahotel/view/usuarios/Usuarios.fxml", apPrincipal);
    }
